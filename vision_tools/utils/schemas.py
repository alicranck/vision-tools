...
# ---------------------------------------------------------------------------
# Tool I/O contract types (for pipeline validation)
# ---------------------------------------------------------------------------

class ToolIOContract(BaseModel):
    """
    Declares a tool's typed input/output contract for pipeline validation.
    Tools declare their contracts as class-level attributes.
    """
